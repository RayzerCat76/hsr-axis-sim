...
# ARCH-019, ARCH-031, ARCH-034, ARCH-037, and ARCH-040 explicitly authorize
# additive changes to runtime_contracts/__init__.py and runtime_contracts/enums.py.
# Historical ARCH-002 evidence remains pinned, while every untouched
# runtime-contract source stays byte-for-byte protected.
CONTRACT_HASHES = {
...
def test_runtime_contract_sources_not_authorized_by_arch_019_031_034_037_or_040_are_unchanged():
