...
# ARCH-003 evidence remains pinned and every other upstream source stays exact.
SOURCE_HASHES = {
...
def test_contract_and_adapter_sources_not_authorized_by_arch_019_or_arch_020_are_unchanged():
