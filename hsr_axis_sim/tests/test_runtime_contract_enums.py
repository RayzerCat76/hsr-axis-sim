...
EXPECTED = {
    ...
    "RuntimeEventType": ["BATTLE_START", "WAVE_START", "TURN_ENTRY", "TURN_START", "ACTION_QUEUED", "ACTION_START", "ATTACK_DECLARED", "ATTACK_CONTACT", "TARGET_ATTACKED", "HIT_RESOLVED", "BEFORE_DAMAGE", "DAMAGE_RESOLVED", "SHIELD_CHANGED", "SHIELD_DAMAGED", "HP_CHANGED", "HP_DAMAGED", "HP_LOST", "TOUGHNESS_REDUCED", "WEAKNESS_BROKEN", "EFFECT_APPLICATION_ATTEMPT", "EFFECT_APPLIED", "EFFECT_RESISTED", "EFFECT_IMMUNE", "EFFECT_REMOVED", "EFFECT_TRANSFORMED", "FOLLOW_UP_QUEUED", "COUNTER_QUEUED", "EXTRA_TURN_QUEUED", "ACTION_END", "TURN_END", "BEFORE_LETHAL", "LETHAL_INTERCEPTED", "DOWNED", "KNOCKED_DOWN", "DEATH", "REVIVE", "WAVE_END", "BATTLE_END", "CONTENT_DEFINED"],
}
